...
uses
  ...
  FireDAC.Comp.UI, FireDAC.Stan.StorageJSON, FireDAC.Stan.StorageBin, Data.DB,
  FireDAC.Comp.Client, uScanTableThread;
...
begin
  ...
  ScanThread := TScanTableThread.Create(5000);
end;
